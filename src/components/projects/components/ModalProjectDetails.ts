...
export function showModalProject (project: Project) {
    ...
    modal.innerHTML = `
        ...
        <div class="text-white rounded-xl w-full max-w-lg overflow-hidden bg-primary-dark border border-gray-700 relative">
            ...
            <section class="">
                <div class="flex items-center justify-between mb-4 px-7 pt-5">
                    <div class="flex gap-3 items-center">
                        <h4 class="text-white font-bold text-2xl lg:text-xl">${project.title}</h4>
                    ...
                    <p class="text-xs text-gray-400">${project.business}</p>
                </div>
